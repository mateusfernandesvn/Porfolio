...
export default function Home() {
  ...
  return (
    <div className="w-full bg-slate-100 dark:bg-neutral-950">
      <div className="min-h-screen w-full relative overflow-hidden flex items-center justify-center pt-20 pb-10">
        ...
        <div className="w-full flex flex-col-reverse lg:flex-row items-center justify-evenly px-4 md:px-8 relative z-20">
          <div className="flex flex-col gap-3 items-center justify-center text-center">
            <h1 className="text-3xl sm:text-4xl mt-2 md:text-5xl text-purple-900 dark:text-purple-600 uppercase font-black animate-pulse tracking-wide">
              {t("title")}
            </h1>
            <h3 className="text-xl sm:text-2xl text-black dark:text-gray-300 uppercase font-bold">
              {t("caption")}
            </h3>
      ...
      <Container>
        ...
        <div className="flex flex-col py-28 items-center justify-center max-md:py-0">
          <Section id="contact">
            ...
            <p className="text-2xl text-black dark:text-gray-300 font-medium max-w-3xl text-center  max-md:w-full max-md:text-base">
              {t("textContact")}
            </p>
          </Section>
        </div>
